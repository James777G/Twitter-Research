...
public class Tweet {
	 ...
	 * @param countLikes    The amount of likes
	 * @param countRetweets The amount of retweets
	 * @param textString    The tweet
	 * @param hasImage      Whether the tweet has an image
	 * @param hasVideo      Whether the tweet has a video
	 */
